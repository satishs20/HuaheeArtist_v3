<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="personalStock.aspx.cs" Inherits="Assignment.personalStock" %>

<!DOCTYPE html>
<link href="personalStock.css" rel="stylesheet" />
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Personal Stock</title>
...
<body>
    <form id="form1" runat="server">
        <asp:Button ID="Button1" runat="server" Text="Add New Artwork" />
        <br />
      <div class ="grid">
         <div class="content">
